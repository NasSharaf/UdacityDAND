...
\textbf{Answer}: 1) What is the average user time on a bike? If
possible, I'd like to see a histogram to see if there are multiple
averages of use (maybe one group of users use bikes for fifteen minutes,
but there is a smaller user base that uses the bikes for an hour).
...
\tightlist
\item
  Some economists have used rideshare data to construct what is known as
  a demand curve, a theoretical description of how a market demands a
  service or product. If possible, I'd like to see if this sort of
  demand curve can be constructed from the data available.
\end{enumerate}
...
{\color{incolor}In [{\color{incolor}1}]:} \PY{c+c1}{\PYZsh{}\PYZsh{} import all necessary packages and functions.}
        ...
        \PY{k+kn}{import} \PY{n+nn}{calendar} \PY{c+c1}{\PYZsh{}calendar functions, like day of the week by name}
...
{\color{incolor}In [{\color{incolor}3}]:} \PY{k}{def} \PY{n+nf}{duration\PYZus{}in\PYZus{}mins}\PY{p}{(}\PY{n}{datum}\PY{p}{,} \PY{n}{city}\PY{p}{)}\PY{p}{:}
        ...
        \PY{l+s+sd}{    \PYZdq{}\PYZdq{}\PYZdq{}}
            ...
            \PY{k}{if} \PY{n}{city} \PY{o}{==} \PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{Washington}\PY{l+s+s2}{\PYZdq{}}\PY{p}{:}
                \PY{n}{duration} \PY{o}{=} \PY{p}{(}\PY{n+nb}{float}\PY{p}{(}\PY{n}{datum}\PY{p}{[}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Duration (ms)}\PY{l+s+s1}{\PYZsq{}}\PY{p}{]}\PY{p}{)}\PY{o}{/}\PY{l+m+mi}{60}\PY{p}{)}\PY{o}{/}\PY{l+m+mi}{1000}
            \PY{k}{else}\PY{p}{:}
                \PY{n}{duration} \PY{o}{=} \PY{p}{(}\PY{n+nb}{float}\PY{p}{(}\PY{n}{datum}\PY{p}{[}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{tripduration}\PY{l+s+s1}{\PYZsq{}}\PY{p}{]}\PY{p}{)}\PY{p}{)}\PY{o}{/}\PY{l+m+mi}{60}
...
{\color{incolor}In [{\color{incolor}4}]:} \PY{k}{def} \PY{n+nf}{time\PYZus{}of\PYZus{}trip}\PY{p}{(}\PY{n}{datum}\PY{p}{,} \PY{n}{city}\PY{p}{)}\PY{p}{:}
        ...
        \PY{l+s+sd}{    \PYZdq{}\PYZdq{}\PYZdq{}}
            \PY{k}{if} \PY{n}{city} \PY{o}{==} \PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{NYC}\PY{l+s+s2}{\PYZdq{}}\PY{p}{:}
                ...
                \PY{n}{month}\PY{o}{=}\PY{n}{time}\PY{o}{.}\PY{n}{month}
                \PY{n}{day\PYZus{}of\PYZus{}week}\PY{o}{=}\PY{n}{datetime}\PY{o}{.}\PY{n}{strftime}\PY{p}{(}\PY{n}{time}\PY{p}{,}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{\PYZpc{}}\PY{l+s+s1}{A}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}
                \PY{n}{hour}\PY{o}{=}\PY{n}{time}\PY{o}{.}\PY{n}{hour}
...
{\color{incolor}In [{\color{incolor}16}]:} \PY{k}{def} \PY{n+nf}{type\PYZus{}of\PYZus{}user}\PY{p}{(}\PY{n}{datum}\PY{p}{,} \PY{n}{city}\PY{p}{)}\PY{p}{:}
         ...
         \PY{l+s+sd}{    \PYZdq{}\PYZdq{}\PYZdq{}}
             ...
             \PY{c+c1}{\PYZsh{} YOUR CODE HERE}
             \PY{k}{if} \PY{n}{city} \PY{o}{==} \PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{Washington}\PY{l+s+s2}{\PYZdq{}}\PY{p}{:}
                 \PY{k}{if} \PY{n}{datum}\PY{p}{[}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Member Type}\PY{l+s+s1}{\PYZsq{}}\PY{p}{]}\PY{o}{==}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{Registered}\PY{l+s+s2}{\PYZdq{}}\PY{p}{:}
...
Based off of the above data, New York seems to have the highest number
of trips at 276,798 total trips. The highest proportion of trips made by
subscribers happened in New York. The city with the highest number of
trips made by shortterm or casual customers was in Chicago.
...
\end{Verbatim}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}19}]:} \PY{c+c1}{\PYZsh{}\PYZsh{} Modify this and the previous cell to answer Question 4a. Remember to run \PYZsh{}\PYZsh{}}
...
library and to generate an example plot.
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}46}]:} \PY{c+c1}{\PYZsh{} load library}
